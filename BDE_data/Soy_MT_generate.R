...
cor(Pheno_traits)
Pheno_corTraits <- Pheno_traits[,-c(2,5,6)] #leave traits correlated with yield
...
write.csv(p.valid, file = 'data_csv/soy_mt_pheno_valid.csv')
write.csv(m.valid, file = 'data_csv/soy_mt_markers_valid.csv')
write.csv(p.probe, file = 'data_csv/soy_mt_pheno_probe.csv')
write.csv(m.probe, file = 'data_csv/soy_mt_markers_probe.csv')
...
write.csv(p.probe, file = 'data_csv/soy_mt_pheno_probe_check.csv')
write.csv(m.probe, file = 'data_csv/soy_mt_markers_probe_check.csv')
