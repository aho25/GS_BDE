...
write.csv(p.valid, file = 'data_csv/soy_st_pheno_valid.csv')
write.csv(m.valid, file = 'data_csv/soy_st_markers_valid.csv')
write.csv(p.probe, file = 'data_csv/soy_st_pheno_probe.csv')
write.csv(m.probe, file = 'data_csv/soy_st_markers_probe.csv')
...
write.csv(p.probe, file = 'data_csv/soy_st_pheno_probe_check.csv')
write.csv(m.probe, file = 'data_csv/soy_st_markers_probe_check.csv')
