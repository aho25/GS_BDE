...
OBJFUNC.ARGS <- list(df0=DF0, df1=DF1, S0=SCALE, nIter=100, burnIn=70, thin=2, bs=50, saveAt='temp/MTM_')
VAL.ARGS <- list(df0=DF0, df1=DF1, S0=SCALE, nIter=300, burnIn=200, thin=5, bs=50, saveAt='temp/MTM_')
#
...
names(OBJFUNC_Parameters) <- c('OBJFUNC.ARGS$df0', 'OBJFUNC.ARGS$df1', 'OBJFUNC.ARGS$S0', 'OBJFUNC.ARGS$nIter', 'OBJFUNC.ARGS$burnIn', 'OBJFUNC.ARGS$thin', 
                               'OBJFUNC.ARGS$bs')
VALID_Parameters <- c(VAL.ARGS$df0, VAL.ARGS$df1, VAL.ARGS$S0, VAL.ARGS$nIter, VAL.ARGS$burnIn, VAL.ARGS$thin, VAL.ARGS$bs)
names(VALID_Parameters) <- c('VAL.ARGS$df0', 'VAL.ARGS$df1', 'VAL.ARGS$S0', 'VAL.ARGS$nIter', 'VAL.ARGS$burnIn', 'VAL.ARGS$thin', 'VAL.ARGS$bs')